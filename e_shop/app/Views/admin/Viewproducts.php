...
<body class="bg-warning">
    ...
    <div class="container">
            ...
            <div class="row">
                <table class="table">
                    ...
                    <tr>
                        ...
                        <td><a href="<?php echo base_url(); ?>/edit/products?id=<?php echo $data['id']; ?>" class="btn btn-primary" role="button"><i class="fa fa-pencil-square-o"></i></a></td>
                        <td><a href="<?php echo base_url(); ?>/delete/products?id=<?php echo $data['id']; ?>" class="btn btn-danger" role="button"><i class="fa fa-trash"></i></a></td>
                    </tr>
                    <?php }?>
                </table>
        ...
        <center>
            <div class="container">
                <?php
                    echo form_open('/insert/products');
                ?>
